...
export default function OurStory() {
  return (
    <section className="section story-section content-layer" id="about">
      <div className="story-container">
        ...
        >
          ...
          {/* CONTENT SWAP: "Our Story" -> "About" (About section per content spec) */}
          <h2 className="script-text">About</h2>
          <div className="story-content">
            {/* CONTENT SWAP: placeholder love story -> real studio description, warm + professional */}
            <p>
